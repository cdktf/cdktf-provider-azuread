...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/serviceprincipalcertificate"
...
&serviceprincipalcertificate.ServicePrincipalCertificateConfig {
	...
	KeyId: *string,
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.servicePrincipalCertificate.ServicePrincipalCertificateTimeouts,
	Type: *string,
}
```
