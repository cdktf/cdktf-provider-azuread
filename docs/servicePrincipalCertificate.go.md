...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/serviceprincipalcertificate"
...
&serviceprincipalcertificate.ServicePrincipalCertificateConfig {
	...
	KeyId: *string,
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.servicePrincipalCertificate.ServicePrincipalCertificateTimeouts,
	Type: *string,
}
```
