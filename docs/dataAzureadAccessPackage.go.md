...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v6/dataazureadaccesspackage"
...
| <code><a href="#@cdktf/provider-azuread.dataAzureadAccessPackage.DataAzureadAccessPackage.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazureadaccesspackage.DataAzureadAccessPackageConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v6.dataAzureadAccessPackage.DataAzureadAccessPackageTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.dataAzureadAccessPackage.DataAzureadAccessPackageConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
