...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/dataazureaddirectoryobject"
...
&dataazureaddirectoryobject.DataAzureadDirectoryObjectConfig {
	...
	ObjectId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.dataAzureadDirectoryObject.DataAzureadDirectoryObjectTimeouts,
}
```
