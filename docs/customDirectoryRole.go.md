...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v7/customdirectoryrole"
...
&customdirectoryrole.CustomDirectoryRoleConfig {
	...
	Id: *string,
	TemplateId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v7.customDirectoryRole.CustomDirectoryRoleTimeouts,
}
```
