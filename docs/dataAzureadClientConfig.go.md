...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/dataazureadclientconfig"
...
&dataazureadclientconfig.DataAzureadClientConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.dataAzureadClientConfig.DataAzureadClientConfigTimeouts,
}
```
