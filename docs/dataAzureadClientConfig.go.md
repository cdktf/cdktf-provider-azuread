...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureadclientconfig"
...
&dataazureadclientconfig.DataAzureadClientConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadClientConfig.DataAzureadClientConfigTimeouts,
}
```
