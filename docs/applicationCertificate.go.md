...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/applicationcertificate"
...
&applicationcertificate.ApplicationCertificateConfig {
	...
	KeyId: *string,
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.applicationCertificate.ApplicationCertificateTimeouts,
	Type: *string,
}
```
