...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/applicationcertificate"
...
&applicationcertificate.ApplicationCertificateConfig {
	...
	KeyId: *string,
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.applicationCertificate.ApplicationCertificateTimeouts,
	Type: *string,
}
```
