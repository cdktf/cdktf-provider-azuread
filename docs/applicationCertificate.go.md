...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/applicationcertificate"
...
&applicationcertificate.ApplicationCertificateConfig {
	...
	KeyId: *string,
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.applicationCertificate.ApplicationCertificateTimeouts,
	Type: *string,
}
```
...
| <code><a href="#@cdktf/provider-azuread.applicationCertificate.ApplicationCertificateConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.41.0/docs/resources/application_certificate#id ApplicationCertificate#id}. |
...
| <code><a href="#@cdktf/provider-azuread.applicationCertificate.ApplicationCertificateTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.41.0/docs/resources/application_certificate#read ApplicationCertificate#read}. |
