...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/applicationcertificate"
...
&applicationcertificate.ApplicationCertificateConfig {
	...
	KeyId: *string,
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.applicationCertificate.ApplicationCertificateTimeouts,
	Type: *string,
}
```
