...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/directoryroleeligibilityschedulerequest"
...
&directoryroleeligibilityschedulerequest.DirectoryRoleEligibilityScheduleRequestConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.directoryRoleEligibilityScheduleRequest.DirectoryRoleEligibilityScheduleRequestTimeouts,
}
```
