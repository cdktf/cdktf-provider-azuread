...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/group"
...
&group.GroupConfig {
	...
	Behaviors: *[]*string,
	Description: *string,
	DynamicMembership: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.group.GroupDynamicMembership,
	...
	Theme: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.group.GroupTimeouts,
	Types: *[]*string,
	Visibility: *string,
