...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureadserviceprincipal"
...
&dataazureadserviceprincipal.DataAzureadServicePrincipalConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadServicePrincipal.DataAzureadServicePrincipalTimeouts,
}
```
