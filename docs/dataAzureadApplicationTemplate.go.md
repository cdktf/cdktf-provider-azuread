...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/dataazureadapplicationtemplate"
...
&dataazureadapplicationtemplate.DataAzureadApplicationTemplateConfig {
	...
	Id: *string,
	TemplateId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.dataAzureadApplicationTemplate.DataAzureadApplicationTemplateTimeouts,
}
```
