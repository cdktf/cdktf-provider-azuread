...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v13/dataazureadapplicationtemplate"
...
&dataazureadapplicationtemplate.DataAzureadApplicationTemplateConfig {
	...
	Id: *string,
	TemplateId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v13.dataAzureadApplicationTemplate.DataAzureadApplicationTemplateTimeouts,
}
```
