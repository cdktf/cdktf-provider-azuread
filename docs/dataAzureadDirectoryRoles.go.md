...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v13/dataazureaddirectoryroles"
...
&dataazureaddirectoryroles.DataAzureadDirectoryRolesConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v13.dataAzureadDirectoryRoles.DataAzureadDirectoryRolesTimeouts,
}
```
