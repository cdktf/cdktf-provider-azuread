...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/dataazureaddirectoryroles"
...
&dataazureaddirectoryroles.DataAzureadDirectoryRolesConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.dataAzureadDirectoryRoles.DataAzureadDirectoryRolesTimeouts,
}
```
