...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureaddirectoryroles"
...
&dataazureaddirectoryroles.DataAzureadDirectoryRolesConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadDirectoryRoles.DataAzureadDirectoryRolesTimeouts,
}
```
