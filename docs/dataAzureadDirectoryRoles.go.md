...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/dataazureaddirectoryroles"
...
&dataazureaddirectoryroles.DataAzureadDirectoryRolesConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.dataAzureadDirectoryRoles.DataAzureadDirectoryRolesTimeouts,
}
```
