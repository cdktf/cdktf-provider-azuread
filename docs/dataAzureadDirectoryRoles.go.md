...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/dataazureaddirectoryroles"
...
&dataazureaddirectoryroles.DataAzureadDirectoryRolesConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.dataAzureadDirectoryRoles.DataAzureadDirectoryRolesTimeouts,
}
```
