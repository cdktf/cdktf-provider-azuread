...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/dataazureadgroups"
...
&dataazureadgroups.DataAzureadGroupsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.dataAzureadGroups.DataAzureadGroupsTimeouts,
}
```
