...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v13/dataazureadgroups"
...
&dataazureadgroups.DataAzureadGroupsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v13.dataAzureadGroups.DataAzureadGroupsTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.dataAzureadGroups.DataAzureadGroupsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/data-sources/groups#id DataAzureadGroups#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azuread.dataAzureadGroups.DataAzureadGroupsTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/data-sources/groups#read DataAzureadGroups#read}. |
