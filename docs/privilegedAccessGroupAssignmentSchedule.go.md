...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/privilegedaccessgroupassignmentschedule"
...
&privilegedaccessgroupassignmentschedule.PrivilegedAccessGroupAssignmentScheduleConfig {
	...
	TicketNumber: *string,
	TicketSystem: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.privilegedAccessGroupAssignmentSchedule.PrivilegedAccessGroupAssignmentScheduleTimeouts,
}
```
