...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureaddomains"
...
&dataazureaddomains.DataAzureadDomainsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadDomains.DataAzureadDomainsTimeouts,
}
```
