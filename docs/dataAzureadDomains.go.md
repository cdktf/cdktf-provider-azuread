...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/dataazureaddomains"
...
&dataazureaddomains.DataAzureadDomainsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.dataAzureadDomains.DataAzureadDomainsTimeouts,
}
```
