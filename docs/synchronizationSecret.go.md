...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/synchronizationsecret"
...
&synchronizationsecret.SynchronizationSecretConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.synchronizationSecret.SynchronizationSecretTimeouts,
}
```
