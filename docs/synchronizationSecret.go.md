...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/synchronizationsecret"
...
&synchronizationsecret.SynchronizationSecretConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.synchronizationSecret.SynchronizationSecretTimeouts,
}
```
