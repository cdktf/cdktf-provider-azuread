...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureadgroup"
...
&dataazureadgroup.DataAzureadGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadGroup.DataAzureadGroupTimeouts,
}
```
