...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/dataazureadgroup"
...
&dataazureadgroup.DataAzureadGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.dataAzureadGroup.DataAzureadGroupTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.dataAzureadGroup.DataAzureadGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.40.0/docs/data-sources/group#id DataAzureadGroup#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azuread.dataAzureadGroup.DataAzureadGroupTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.40.0/docs/data-sources/group#read DataAzureadGroup#read}. |
