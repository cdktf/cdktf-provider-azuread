...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/serviceprincipaldelegatedpermissiongrant"
...
&serviceprincipaldelegatedpermissiongrant.ServicePrincipalDelegatedPermissionGrantConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.servicePrincipalDelegatedPermissionGrant.ServicePrincipalDelegatedPermissionGrantTimeouts,
	UserObjectId: *string,
}
```
