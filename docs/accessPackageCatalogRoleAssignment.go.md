...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/accesspackagecatalogroleassignment"
...
&accesspackagecatalogroleassignment.AccessPackageCatalogRoleAssignmentConfig {
	...
	RoleId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.accessPackageCatalogRoleAssignment.AccessPackageCatalogRoleAssignmentTimeouts,
}
```
