...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v12/administrativeunitmember"
...
&administrativeunitmember.AdministrativeUnitMemberConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v12.administrativeUnitMember.AdministrativeUnitMemberTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.administrativeUnitMember.AdministrativeUnitMemberConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.48.0/docs/resources/administrative_unit_member#id AdministrativeUnitMember#id}. |
