...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/administrativeunitmember"
...
&administrativeunitmember.AdministrativeUnitMemberConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.administrativeUnitMember.AdministrativeUnitMemberTimeouts,
}
```
