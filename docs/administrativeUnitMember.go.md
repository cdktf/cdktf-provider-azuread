...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/administrativeunitmember"
...
| <code><a href="#@cdktf/provider-azuread.administrativeUnitMember.AdministrativeUnitMember.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&administrativeunitmember.AdministrativeUnitMemberConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.administrativeUnitMember.AdministrativeUnitMemberTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.administrativeUnitMember.AdministrativeUnitMemberConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
