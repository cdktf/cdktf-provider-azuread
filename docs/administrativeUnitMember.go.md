...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/administrativeunitmember"
...
&administrativeunitmember.AdministrativeUnitMemberConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.administrativeUnitMember.AdministrativeUnitMemberTimeouts,
}
```
