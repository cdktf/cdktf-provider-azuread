...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/groupmember"
...
&groupmember.GroupMemberConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.groupMember.GroupMemberTimeouts,
}
```
