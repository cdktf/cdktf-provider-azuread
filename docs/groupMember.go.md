...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/groupmember"
...
&groupmember.GroupMemberConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.groupMember.GroupMemberTimeouts,
}
```
