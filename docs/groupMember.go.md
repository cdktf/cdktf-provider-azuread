...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v7/groupmember"
...
&groupmember.GroupMemberConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v7.groupMember.GroupMemberTimeouts,
}
```
