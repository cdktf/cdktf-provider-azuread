...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/dataazureaddirectoryroletemplates"
...
&dataazureaddirectoryroletemplates.DataAzureadDirectoryRoleTemplatesConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.dataAzureadDirectoryRoleTemplates.DataAzureadDirectoryRoleTemplatesTimeouts,
}
```
