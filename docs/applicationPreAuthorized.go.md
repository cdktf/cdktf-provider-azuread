...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/applicationpreauthorized"
...
&applicationpreauthorized.ApplicationPreAuthorizedConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.applicationPreAuthorized.ApplicationPreAuthorizedTimeouts,
}
```
