...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/applicationpreauthorized"
...
&applicationpreauthorized.ApplicationPreAuthorizedConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.applicationPreAuthorized.ApplicationPreAuthorizedTimeouts,
}
```
