...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/applicationpreauthorized"
...
&applicationpreauthorized.ApplicationPreAuthorizedConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.applicationPreAuthorized.ApplicationPreAuthorizedTimeouts,
}
```
