...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v12/authenticationstrengthpolicy"
...
&authenticationstrengthpolicy.AuthenticationStrengthPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v12.authenticationStrengthPolicy.AuthenticationStrengthPolicyTimeouts,
}
```
