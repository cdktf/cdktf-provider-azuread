...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v13/authenticationstrengthpolicy"
...
&authenticationstrengthpolicy.AuthenticationStrengthPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v13.authenticationStrengthPolicy.AuthenticationStrengthPolicyTimeouts,
}
```
