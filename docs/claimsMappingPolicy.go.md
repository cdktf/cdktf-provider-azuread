...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v11/claimsmappingpolicy"
...
| <code><a href="#@cdktf/provider-azuread.claimsMappingPolicy.ClaimsMappingPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.46.0/docs/resources/claims_mapping_policy#id ClaimsMappingPolicy#id}. |
