...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/dataazureadapplication"
...
&dataazureadapplication.DataAzureadApplicationConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.dataAzureadApplication.DataAzureadApplicationTimeouts,
}
```
