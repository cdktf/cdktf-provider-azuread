...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureadapplication"
...
&dataazureadapplication.DataAzureadApplicationConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadApplication.DataAzureadApplicationTimeouts,
}
```
