...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/applicationpassword"
...
&applicationpassword.ApplicationPasswordConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.applicationPassword.ApplicationPasswordTimeouts,
}
```
