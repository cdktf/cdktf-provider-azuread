...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/applicationpassword"
...
&applicationpassword.ApplicationPasswordAConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.applicationPassword.ApplicationPasswordTimeouts,
}
```
