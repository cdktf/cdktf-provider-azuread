...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/applicationpassword"
...
&applicationpassword.ApplicationPasswordConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.applicationPassword.ApplicationPasswordTimeouts,
}
```
