...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/dataazureadnamedlocation"
...
&dataazureadnamedlocation.DataAzureadNamedLocationConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.dataAzureadNamedLocation.DataAzureadNamedLocationTimeouts,
}
```
