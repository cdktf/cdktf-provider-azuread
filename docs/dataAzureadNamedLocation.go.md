...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/dataazureadnamedlocation"
...
&dataazureadnamedlocation.DataAzureadNamedLocationConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.dataAzureadNamedLocation.DataAzureadNamedLocationTimeouts,
}
```
