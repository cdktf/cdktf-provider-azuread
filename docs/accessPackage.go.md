...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/accesspackage"
...
&accesspackage.AccessPackageConfig {
	...
	Hidden: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.accessPackage.AccessPackageTimeouts,
}
```
