...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/accesspackageresourcepackageassociation"
...
&accesspackageresourcepackageassociation.AccessPackageResourcePackageAssociationConfig {
	...
	AccessType: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.accessPackageResourcePackageAssociation.AccessPackageResourcePackageAssociationTimeouts,
}
```
