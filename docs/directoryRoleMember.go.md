...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/directoryrolemember"
...
&directoryrolemember.DirectoryRoleMemberConfig {
	...
	RoleObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.directoryRoleMember.DirectoryRoleMemberTimeouts,
}
```
