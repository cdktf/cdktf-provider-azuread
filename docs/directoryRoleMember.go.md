...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v7/directoryrolemember"
...
&directoryrolemember.DirectoryRoleMemberConfig {
	...
	RoleObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v7.directoryRoleMember.DirectoryRoleMemberTimeouts,
}
```
