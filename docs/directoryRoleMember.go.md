...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v6/directoryrolemember"
...
| <code><a href="#@cdktf/provider-azuread.directoryRoleMember.DirectoryRoleMember.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&directoryrolemember.DirectoryRoleMemberConfig {
	...
	RoleObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v6.directoryRoleMember.DirectoryRoleMemberTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.directoryRoleMember.DirectoryRoleMemberConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
