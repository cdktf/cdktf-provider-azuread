...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/directoryrolemember"
...
&directoryrolemember.DirectoryRoleMemberConfig {
	...
	RoleObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.directoryRoleMember.DirectoryRoleMemberTimeouts,
}
```
