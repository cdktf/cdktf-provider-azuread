...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/administrativeunitrolemember"
...
&administrativeunitrolemember.AdministrativeUnitRoleMemberConfig {
	...
	RoleObjectId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.administrativeUnitRoleMember.AdministrativeUnitRoleMemberTimeouts,
}
```
