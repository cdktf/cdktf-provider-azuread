...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v12/provider"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.53.0/docs#import import section} in the documentation of this resource for the id to use
