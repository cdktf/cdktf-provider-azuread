...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/directoryrole"
...
&directoryrole.DirectoryRoleConfig {
	...
	Id: *string,
	TemplateId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.directoryRole.DirectoryRoleTimeouts,
}
```
