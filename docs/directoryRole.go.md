...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/directoryrole"
...
&directoryrole.DirectoryRoleConfig {
	...
	Id: *string,
	TemplateId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.directoryRole.DirectoryRoleTimeouts,
}
```
