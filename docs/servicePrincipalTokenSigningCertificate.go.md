...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v13/serviceprincipaltokensigningcertificate"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.0.2/docs/resources/service_principal_token_signing_certificate#import import section} in the documentation of this resource for the id to use
...
&serviceprincipaltokensigningcertificate.ServicePrincipalTokenSigningCertificateConfig {
	...
	EndDate: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v13.servicePrincipalTokenSigningCertificate.ServicePrincipalTokenSigningCertificateTimeouts,
}
```
