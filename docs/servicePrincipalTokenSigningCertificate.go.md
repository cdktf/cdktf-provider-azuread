...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/serviceprincipaltokensigningcertificate"
...
&serviceprincipaltokensigningcertificate.ServicePrincipalTokenSigningCertificateConfig {
	...
	EndDate: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.servicePrincipalTokenSigningCertificate.ServicePrincipalTokenSigningCertificateTimeouts,
}
```
