...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/serviceprincipaltokensigningcertificate"
...
&serviceprincipaltokensigningcertificate.ServicePrincipalTokenSigningCertificateConfig {
	...
	EndDate: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.servicePrincipalTokenSigningCertificate.ServicePrincipalTokenSigningCertificateTimeouts,
}
```
