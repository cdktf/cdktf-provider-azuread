...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/applicationowner"
...
&applicationowner.ApplicationOwnerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.applicationOwner.ApplicationOwnerTimeouts,
}
```
