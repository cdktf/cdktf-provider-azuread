...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v6/directoryroleassignment"
...
| <code><a href="#@cdktf/provider-azuread.directoryRoleAssignment.DirectoryRoleAssignment.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&directoryroleassignment.DirectoryRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v6.directoryRoleAssignment.DirectoryRoleAssignmentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.directoryRoleAssignment.DirectoryRoleAssignmentConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
