...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v7/directoryroleassignment"
...
&directoryroleassignment.DirectoryRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v7.directoryRoleAssignment.DirectoryRoleAssignmentTimeouts,
}
```
