...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/directoryroleassignment"
...
&directoryroleassignment.DirectoryRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.directoryRoleAssignment.DirectoryRoleAssignmentTimeouts,
}
```
