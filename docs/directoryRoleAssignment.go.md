...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/directoryroleassignment"
...
&directoryroleassignment.DirectoryRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.directoryRoleAssignment.DirectoryRoleAssignmentTimeouts,
}
```
