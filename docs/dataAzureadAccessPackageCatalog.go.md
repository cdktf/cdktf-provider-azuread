...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v10/dataazureadaccesspackagecatalog"
...
&dataazureadaccesspackagecatalog.DataAzureadAccessPackageCatalogConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v10.dataAzureadAccessPackageCatalog.DataAzureadAccessPackageCatalogTimeouts,
}
```
