...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v7/dataazureadaccesspackagecatalog"
...
&dataazureadaccesspackagecatalog.DataAzureadAccessPackageCatalogConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v7.dataAzureadAccessPackageCatalog.DataAzureadAccessPackageCatalogTimeouts,
}
```
