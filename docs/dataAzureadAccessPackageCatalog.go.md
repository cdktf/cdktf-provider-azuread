...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v6/dataazureadaccesspackagecatalog"
...
| <code><a href="#@cdktf/provider-azuread.dataAzureadAccessPackageCatalog.DataAzureadAccessPackageCatalog.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazureadaccesspackagecatalog.DataAzureadAccessPackageCatalogConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v6.dataAzureadAccessPackageCatalog.DataAzureadAccessPackageCatalogTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.dataAzureadAccessPackageCatalog.DataAzureadAccessPackageCatalogConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
