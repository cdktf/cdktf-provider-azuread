...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v13/dataazureadaccesspackagecatalog"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/data-sources/access_package_catalog#import import section} in the documentation of this resource for the id to use
...
&dataazureadaccesspackagecatalog.DataAzureadAccessPackageCatalogConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v13.dataAzureadAccessPackageCatalog.DataAzureadAccessPackageCatalogTimeouts,
}
```
