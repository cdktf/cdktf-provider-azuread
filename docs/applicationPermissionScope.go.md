...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/applicationpermissionscope"
...
&applicationpermissionscope.ApplicationPermissionScopeConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.applicationPermissionScope.ApplicationPermissionScopeTimeouts,
	Type: *string,
