...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/userflowattribute"
...
&userflowattribute.UserFlowAttributeConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.userFlowAttribute.UserFlowAttributeTimeouts,
}
```
