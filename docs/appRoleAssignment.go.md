...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/approleassignment"
...
&approleassignment.AppRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.appRoleAssignment.AppRoleAssignmentTimeouts,
}
```
