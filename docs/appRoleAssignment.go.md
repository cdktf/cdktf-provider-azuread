...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/approleassignment"
...
&approleassignment.AppRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.appRoleAssignment.AppRoleAssignmentTimeouts,
}
```
