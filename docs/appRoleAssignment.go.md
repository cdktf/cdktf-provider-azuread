...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v6/approleassignment"
...
&approleassignment.AppRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v6.appRoleAssignment.AppRoleAssignmentTimeouts,
}
```
