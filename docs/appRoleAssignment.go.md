...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/approleassignment"
...
| <code><a href="#@cdktf/provider-azuread.appRoleAssignment.AppRoleAssignment.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&approleassignment.AppRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.appRoleAssignment.AppRoleAssignmentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.appRoleAssignment.AppRoleAssignmentConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
