...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/approleassignment"
...
&approleassignment.AppRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread.appRoleAssignment.AppRoleAssignmentTimeouts,
}
```
