...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/approleassignment"
...
&approleassignment.AppRoleAssignmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.appRoleAssignment.AppRoleAssignmentTimeouts,
}
```
