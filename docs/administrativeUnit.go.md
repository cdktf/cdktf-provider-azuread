...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/administrativeunit"
...
&administrativeunit.AdministrativeUnitConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.administrativeUnit.AdministrativeUnitTimeouts,
}
```
