...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/administrativeunit"
...
&administrativeunit.AdministrativeUnitConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.administrativeUnit.AdministrativeUnitTimeouts,
}
```
