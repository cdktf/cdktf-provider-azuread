...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/administrativeunit"
...
&administrativeunit.AdministrativeUnitConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.administrativeUnit.AdministrativeUnitTimeouts,
}
```
