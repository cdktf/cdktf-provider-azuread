...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/applicationfederatedidentitycredential"
...
&applicationfederatedidentitycredential.ApplicationFederatedIdentityCredentialConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.applicationFederatedIdentityCredential.ApplicationFederatedIdentityCredentialTimeouts,
}
```
