...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureaduser"
...
&dataazureaduser.DataAzureadUserConfig {
	...
	MailNickname: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadUser.DataAzureadUserTimeouts,
