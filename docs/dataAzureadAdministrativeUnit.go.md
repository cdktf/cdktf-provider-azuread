...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/dataazureadadministrativeunit"
...
&dataazureadadministrativeunit.DataAzureadAdministrativeUnitConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.dataAzureadAdministrativeUnit.DataAzureadAdministrativeUnitTimeouts,
}
```
