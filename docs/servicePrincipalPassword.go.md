...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/serviceprincipalpassword"
...
&serviceprincipalpassword.ServicePrincipalPasswordConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.servicePrincipalPassword.ServicePrincipalPasswordTimeouts,
}
```
