...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v5/serviceprincipalpassword"
...
| <code><a href="#@cdktf/provider-azuread.servicePrincipalPassword.ServicePrincipalPassword.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&serviceprincipalpassword.ServicePrincipalPasswordConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v5.servicePrincipalPassword.ServicePrincipalPasswordTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azuread.servicePrincipalPassword.ServicePrincipalPasswordConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
