...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v7/serviceprincipalpassword"
...
&serviceprincipalpassword.ServicePrincipalPasswordConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v7.servicePrincipalPassword.ServicePrincipalPasswordTimeouts,
}
```
