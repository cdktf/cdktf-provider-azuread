...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v9/serviceprincipalpassword"
...
&serviceprincipalpassword.ServicePrincipalPasswordConfig {
	...
	StartDate: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v9.servicePrincipalPassword.ServicePrincipalPasswordTimeouts,
}
```
