...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v14/applicationapprole"
...
&applicationapprole.ApplicationAppRoleAConfig {
	...
	RoleId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v14.applicationAppRole.ApplicationAppRoleTimeouts,
	Value: *string,
}
```
