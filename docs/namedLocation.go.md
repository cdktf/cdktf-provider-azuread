...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/namedlocation"
...
&namedlocation.NamedLocationConfig {
	...
	DisplayName: *string,
	Country: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.namedLocation.NamedLocationCountry,
	Id: *string,
	Ip: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.namedLocation.NamedLocationIp,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.namedLocation.NamedLocationTimeouts,
}
```
