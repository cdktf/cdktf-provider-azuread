...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureadaccesspackagecatalogrole"
...
&dataazureadaccesspackagecatalogrole.DataAzureadAccessPackageCatalogRoleConfig {
	...
	Id: *string,
	ObjectId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadAccessPackageCatalogRole.DataAzureadAccessPackageCatalogRoleTimeouts,
}
```
