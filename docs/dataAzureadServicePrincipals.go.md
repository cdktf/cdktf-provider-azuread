...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v8/dataazureadserviceprincipals"
...
&dataazureadserviceprincipals.DataAzureadServicePrincipalsConfig {
	...
	ObjectIds: *[]*string,
	ReturnAll: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v8.dataAzureadServicePrincipals.DataAzureadServicePrincipalsTimeouts,
}
```
