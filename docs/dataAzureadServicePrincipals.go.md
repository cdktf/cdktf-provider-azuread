...
```go
import "github.com/cdktf/cdktf-provider-azuread-go/azuread/v7/dataazureadserviceprincipals"
...
&dataazureadserviceprincipals.DataAzureadServicePrincipalsConfig {
	...
	ObjectIds: *[]*string,
	ReturnAll: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azuread-go/azuread/v7.dataAzureadServicePrincipals.DataAzureadServicePrincipalsTimeouts,
}
```
