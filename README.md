...
# CDKTF prebuilt bindings for hashicorp/azuread provider version 2.46.0

This repo builds and publishes the [Terraform azuread provider](https://registry.terraform.io/providers/hashicorp/azuread/2.46.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
