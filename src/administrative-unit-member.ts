...
export function administrativeUnitMemberTimeoutsToTerraform(struct?: AdministrativeUnitMemberTimeoutsOutputReference | AdministrativeUnitMemberTimeouts): any {
...
export class AdministrativeUnitMemberTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: AdministrativeUnitMemberTimeouts | undefined) {
    if (value === undefined) {
...
export class AdministrativeUnitMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AdministrativeUnitMemberTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
