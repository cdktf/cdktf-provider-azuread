...
export function directoryRoleMemberTimeoutsToTerraform(struct?: DirectoryRoleMemberTimeoutsOutputReference | DirectoryRoleMemberTimeouts | cdktf.IResolvable): any {
...
export class DirectoryRoleMemberTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DirectoryRoleMemberTimeouts | undefined {
  ...
  public set internalValue(value: DirectoryRoleMemberTimeouts | undefined) {
    if (value === undefined) {
...
export class DirectoryRoleMember extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DirectoryRoleMemberTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
