...
// https://registry.terraform.io/providers/hashicorp/azuread/2.53.0/docs/resources/directory_role_member
...
export function directoryRoleMemberTimeoutsToTerraform(struct?: DirectoryRoleMemberTimeouts | cdktf.IResolvable): any {
...
export function directoryRoleMemberTimeoutsToHclTerraform(struct?: DirectoryRoleMemberTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DirectoryRoleMemberTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DirectoryRoleMemberTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DirectoryRoleMemberTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DirectoryRoleMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryRoleMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.53.0/docs/resources/directory_role_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "azuread_directory_role_member", importId: importFromId, provider });
      }
