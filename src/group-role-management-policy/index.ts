...
// https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/resources/group_role_management_policy
...
export class GroupRoleManagementPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupRoleManagementPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/resources/group_role_management_policy#import import section} in the documentation of this resource for the id to use
