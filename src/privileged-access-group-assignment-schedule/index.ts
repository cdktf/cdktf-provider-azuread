// https://registry.terraform.io/providers/hashicorp/azuread/2.49.1/docs/resources/privileged_access_group_assignment_schedule
...
export class PrivilegedAccessGroupAssignmentSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivilegedAccessGroupAssignmentSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.49.1/docs/resources/privileged_access_group_assignment_schedule#import import section} in the documentation of this resource for the id to use
