...
// https://registry.terraform.io/providers/hashicorp/azuread/2.49.0/docs
...
export class AzureadProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AzureadProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.49.0/docs#import import section} in the documentation of this resource for the id to use
