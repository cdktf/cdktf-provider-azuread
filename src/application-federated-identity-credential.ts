...
export function applicationFederatedIdentityCredentialTimeoutsToTerraform(struct?: ApplicationFederatedIdentityCredentialTimeoutsOutputReference | ApplicationFederatedIdentityCredentialTimeouts): any {
...
export class ApplicationFederatedIdentityCredential extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApplicationFederatedIdentityCredentialTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
