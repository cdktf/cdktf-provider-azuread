...
export function applicationFederatedIdentityCredentialTimeoutsToTerraform(struct?: ApplicationFederatedIdentityCredentialTimeoutsOutputReference | ApplicationFederatedIdentityCredentialTimeouts | cdktf.IResolvable): any {
...
export class ApplicationFederatedIdentityCredential extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azuread_application_federated_identity_credential";
  ...
  */
  ...
  private _timeouts = new ApplicationFederatedIdentityCredentialTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
