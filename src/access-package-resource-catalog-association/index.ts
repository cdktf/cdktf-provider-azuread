...
// https://registry.terraform.io/providers/hashicorp/azuread/2.47.0/docs/resources/access_package_resource_catalog_association
...
export class AccessPackageResourceCatalogAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessPackageResourceCatalogAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.47.0/docs/resources/access_package_resource_catalog_association#import import section} in the documentation of this resource for the id to use
