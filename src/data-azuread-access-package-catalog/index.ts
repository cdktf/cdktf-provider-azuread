// https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/data-sources/access_package_catalog
...
export class DataAzureadAccessPackageCatalog extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzureadAccessPackageCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/data-sources/access_package_catalog#import import section} in the documentation of this resource for the id to use
