// https://registry.terraform.io/providers/hashicorp/azuread/2.52.0/docs/resources/named_location
...
export class NamedLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NamedLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.52.0/docs/resources/named_location#import import section} in the documentation of this resource for the id to use
