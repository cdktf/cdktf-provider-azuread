// https://registry.terraform.io/providers/hashicorp/azuread/2.51.0/docs/resources/synchronization_job_provision_on_demand
...
export class SynchronizationJobProvisionOnDemand extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SynchronizationJobProvisionOnDemand that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.51.0/docs/resources/synchronization_job_provision_on_demand#import import section} in the documentation of this resource for the id to use
