...
// https://registry.terraform.io/providers/hashicorp/azuread/2.50.0/docs/resources/invitation
...
export class Invitation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Invitation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/2.50.0/docs/resources/invitation#import import section} in the documentation of this resource for the id to use
